...
<body>
    ...
    <h3>EventGaffer, a reliable platform where time and schedule are simply and effortlessly oriented</h3>
    <div class="About">
       EventGaffer is a global self-service ticketing solution forevents ranging from small congregational to big conferences as well as music concerts, marathons, fundraising program and gaming competitions. Now everyone can organize, discover, book and join events that encourage their joy and fulfill their lives. Our purpose is to connect the world together through live escapade.
    </div>
